        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-full bg-white text-gray-700 font-medium hover:bg-gray-50 transition-colors shadow-sm"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-full text-white font-medium hover:opacity-90 transition-opacity shadow-lg"
